...
class spellCMD extends Commando.Command
{
    constructor(Client)
    {
        super(Client,{
            ...
            group: 'dungeons',
            memberName: 'spell',
            description: 'Seach for any spell in D&D 5e for information on it!. Usage: !spell [Spell Name]'
        });
    }
    ...
    async run(message, args)
    {
        ...
        if(args != "")
        {
            //foreach that looks for " of " || " the ". 
                //If found don't do below.
